...
fn main() {
    ...
    println!("{:#.4}", FileSize::KILOBTYE);
    println!("{:#.4}", FileSize::MEGABYTE);
    println!("{:#.4}", FileSize::MEGABYTE);
    println!("{:#.4}", FileSize::KILOBTYE);
    println!("{:#.4}", FileSize::MEGABYTE);
    println!("{:#.4}", FileSize::GIGABYTE);
    println!("{:#.4}", FileSize::TERABYTE);
    println!("{:#.4}", FileSize::PETABYTE);
    println!("{:#.4}", FileSize::EXABYTE);
    println!("{:#.4}", FileSize::KIBIBTYE);
    println!("{:#.4}", FileSize::MEBIBYTE);
    println!("{:#.4}", FileSize::GIBIBYTE);
    println!("{:#.4}", FileSize::TEBIBYTE);
    println!("{:#.4}", FileSize::PEBIBYTE);
    println!("{:#.4}", FileSize::EXIBYTE);
    println!("!");
    println!("{:.4}", FileSize::KILOBTYE);
    println!("{:.4}", FileSize::MEGABYTE);
    println!("{:.4}", FileSize::MEGABYTE);
